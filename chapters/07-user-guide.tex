...
\begin{enumerate}
  ...
  \item copiare il comando \texttt{docker pull} basato su digest riportato nella release o nel file allegato;
  \item eseguire il container definendo almeno \texttt{NODE\_ID}, \texttt{HOST}, \texttt{PORT}, \texttt{WEB\_API\_PORT} e, se necessario, \texttt{BOOTSTRAP\_PEERS}.
\end{enumerate}
...
Un esempio tipico di esecuzione \`e:
\begin{verbatim}
