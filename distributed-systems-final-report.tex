...
\begin{abstract}
\textit{Distributed Sensor Hub} is a fully decentralized peer-to-peer platform for managing and replicating smart-city sensor data across multiple nodes, without any central coordinator. Each node ingests local readings through a pluggable sensor interface, maintains a local replica of global state, and exchanges updates with peers through push-pull gossip.
